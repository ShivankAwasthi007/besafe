                            ...
                            <div class="row pt-4">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">Dashboard</h4>
                                            <p>View your registered schools and your Razorpay balance at a glance</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p>Manage the payment plans and configure every plan detail. Also, configure the system by providing necessary keys for various features including Google Maps, Razorpay, ...</p>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            if(!$plan->is_pay_as_you_go)
            {
                ...
                $plan_children_display_count = "";
                if($plan->allowed_children==-1)
                    $plan_children_display_count = "Unlimited Seats (Children)";
                else if($plan->allowed_children==1)
                    $plan_children_display_count = "Single Seat (Child)";
                else
                    $plan_children_display_count = $plan->allowed_children." Seats (Children)";
            }
            else
            {
                $plan_driver_display_count = "Pay As You Go Tracked Buses";
                $plan_children_display_count = "Pay As You Go Seats";
            }
            ?>
                <div class="col-lg-4 mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <li><span class="fa-li"><i class="fas fa-check"></i></span><strong>{{$plan_children_display_count}}</strong></li>
                        </ul>
                    </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="footer-col">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body"><a href="/terms.html" target="_blank">Terms & conditions</a></div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body"><a href="/privacy.html" target="_blank">Privacy policy</a></div>
                            </li>
                        </ul>
                    </div>
                </div> <!-- end of col -->
